...
import {
  ...
  registerGetAgentPromptTool,
  registerRefreshAgentsTool,
} from "./tools/index.js";
...
export function createServer(): McpServer {
  const server = new McpServer(
    ...
    {
      instructions:
        "You are connected to the Agency MCP server, which indexes AI agent system prompts from a GitHub repository. " +
